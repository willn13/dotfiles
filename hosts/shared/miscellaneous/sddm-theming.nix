...
let
  ...
  themes = {
    aerial = {
      ...
      deps = with pkgs; [ qt5.qtmultimedia qt5.qtgraphicaleffects ];
    };
    ...
    deepin = {
      ...
      deps = with pkgs; [qt5.qtgraphicaleffects];
    };
    ...
    solarized = {
      pkg = rec {
        ...
        themeIni = [
          { section = "General"; key = "background"; value = ./assets/a.png; }
        ];
      };
      ...
      pkg = rec {
        ...
        src = pkgs.fetchFromGitHub {
          ...
          sha256 = "p2d7I0UBP63baW/q9MexYJQcqSmZ0L5rkwK3n66gmqM=";
            ...
            themeIni = [
            { section = "General"; key = "Background"; value = ./assets/Kanagawa.jpeg; }
            { section = "General"; key = "HaveFormBackground"; value = "true"; }
            { section = "General"; key = "FormPosition"; value = "right"; }
            { section = "General"; key = "PartialBlur"; value = "false"; }
            { section = "General"; key = "MainColor"; value = "#DCD7BA"; }
            { section = "General"; key = "AccentColor"; value = "#DCA561"; }
            { section = "General"; key = "BackgroundColor"; value = "#1F1F28"; }
