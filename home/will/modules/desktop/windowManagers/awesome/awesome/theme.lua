...
-- base colors
theme.black = '#16161D'
theme.dimblack = '#2A2A37'
theme.light_black = '#363646'
theme.grey = '#666891'
theme.red = '#c34043'
theme.yellow = '#c0a36e'
theme.magenta = '#957fb8'
theme.green = '#76946a'
theme.blue = '#7e9cd8'
theme.cyan = '#6a9589'
theme.aqua = '#7fb4ca'
...
-- backgrounds
theme.bg_darker     = "#16161D"
theme.bg_normal     = "#1f1f28"
theme.bg_contrast   = "#2A2A37"
theme.bg_lighter    = "#363646"
...
theme.taglist_bg_empty = theme.fg_normal
-- systray
